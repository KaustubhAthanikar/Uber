...
const CaptainRiding = () => {
    ...
    return (
        <div className='h-screen relative'>
            ...
            <div className='h-1/5 p-6 flex justify-center gap-3 items-center relative bg-yellow-400'
            onClick={()=>{
            ...
            >
                ...
                <button className='ml-3 mr-0 bg-green-500 text-white font-semibold p-3 px-10 rounded-lg'>Complete Ride</button>
            </div>
