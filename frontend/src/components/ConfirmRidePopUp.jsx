            ...
            <div className='flex flex-col gap-2 justify-between items-center'>
                ...
                <div className='mt-6 w-full'>
                    <form onSubmit={(e)=>{
                        ...
                        <Link to='/captain-riding' className='w-full text-lg flex justify-center mt-3 bg-green-500 text-white font-semibold p-2 rounded-lg'>Confirm</Link>

                    <button onClick={() => {
                        props.setConfirmRidePopUpPanel(false)
                        props.setRidePopUpPanel(false)
                    }
                    } className='w-full mt-3 bg-red-500 text-lg text-white font-semibold p-2 rounded-lg'>Cancel</button>
